...
GEOIP_CITY_DB = '/geoipdb/GeoLite2-City.mmdb'
GEOIP_ASN_DB = '/geoipdb/GeoLite2-ASN.mmdb'
...
LOG_ENRICHERS = [
    {
        'class_path': "enricher_example.py",
        'class_name': 'ExampleEnricher',
        'config': {'enable_example': True}
    }
]
