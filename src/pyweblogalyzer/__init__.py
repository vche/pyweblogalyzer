from pyweblogalyzer.collector.app import CollectorApp  # ignore F401
from pyweblogalyzer.collector.enrichers import LogEnricherPlugin, install_and_import  # ignore F401
